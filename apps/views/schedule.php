					...
					<div class="row">
						<div class="col-12">
							<div class="card">
								...
								<i class="fa fa-broken fs-4 text-primary"></i> <span class="card-title fs-4">schedules DataTables</span>
												...
												<div class="alert alert-success p-2 d-none"role="alert">
													...
													<form id="scheduleForm">
														<div class="row">
															...
															<div class="form-group">
																<label for="ficility_id" class="fw-bold text-dark">Ficility Id <span class="text-muted">*</span></label>
                                                            ...
                                                            <div class="form-group">
																<label for="days_of_week" class="fw-bold text-dark">Days Of Week <span class="text-muted">*</span></label>
																<input name="days_of_week" id="days_of_week" class="form-control" placeholder="e.g: Sabti, Axad">
                                                            ...
                                                            <div class="form-group">
																<label for="start_date" class="fw-bold text-dark">Start Date <span class="text-muted">*</span></label>
																<input type="date" name="start_date" id="start_date" class="form-control">	
															</div>

                                                            <div class="form-group">
																<label for="end_date" class="fw-bold text-dark">End Date <span class="text-muted">*</span></label>
